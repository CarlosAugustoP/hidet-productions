        ...
        <div className="flex h-[90vh]" id="hero">
            <div className="w-2/3 flex flex-col h-full justify-between p-16">
                ...
                <div className='h-3/4 flex justify-between flex-col mb-5'>
                    <h1 className={`text-white text-left font-semibold ${
                        isHeightExceeded 
                            ? 'text-huge leading-tight' 
                            : 'text-4xl sm:text-5xl md:text-custom-3xl-4xl lg:text-custom-5xl-6xl xl:text-7xl 2xl:text-7xl'
                    }`}>
                    ...
                    <div className='flex items-center gap-5'>
                        ...
                        <p className={`text-xl sm:text-xxl md:text-xl lg:text-2xl xl:text-3xl text-white ${isHeightExceeded ? '2xl:text-4xl' : 'text-xl sm:text-xxl md:text-xl lg:text-2xl xl:text-3xl'}`} >
                    ...
                    <div className='flex gap-6 items-center'>
                        <button className='hover:scale-110 cursor-pointer transition-transform duration-200 rounded-[5px] bg-white text-black flex items-center px-2 sm:px-4 lg:px-5'>
                            <a href="#contact" className={`${isHeightExceeded ? '2xl:text-3xl' : 'text-lg sm:text-xl md:text-sm lg:text-lg xl:text-2xl 2xl:text-2xl'} text-black py-2 sm:py-3 lg:py-2 px-4 sm:px-5 lg:px-4`}>
                                Entre em contato
                            </a>
                        </button>
                        <button className='hover:scale-110 cursor-pointer transition-transform duration-200 rounded-[5px] bg-white text-black flex items-center gap-1 px-3 sm:px-4 lg:px-5'>
                            ...
                            <a onClick={() => Router.push('/portfolio')} className={`${isHeightExceeded ? '2xl:text-3xl' : 'text-lg sm:text-xl md:text-sm lg:text-lg xl:text-2xl 2xl:text-2xl'} text-black py-2 sm:py-3 lg:py-2 px-4 sm:px-5 lg:px-4`}>
                                Conheça-nos
                            </a>
                        </button>
                    </div>
