        ...
        <div className="flex h-[90vh]">
            <div className="w-2/3 flex flex-col h-full justify-between p-16">
                ...
                <div className='h-2/3 flex justify-between flex-col mb-5'>
                    <h1 className="text-white text-4xl sm:text-5xl md:text-custom-3xl-4xl lg:text-custom-5xl-6xl xl:text-7xl 2xl:text-8xl text-left font-semibold">
                    ...
                    <div className='flex gap-6 items-center'>
                        <button className='rounded-lg bg-white text-black'>
                            <p className='text-lg sm:text-xl md:text-sm lg:text-lg xl:text-2xl 2xl:text-3xl text-black py-2 sm:py-3 lg:py-2 px-4 sm:px-5 lg:px-4'>
                                Entre em contato
                            </p>
                        </button>
